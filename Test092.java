...
//Test091.java 비교
//데이터 복사 방법
//--int 형 배열에 대한 깉은 의미의 복사를 처리하는 메소드를 정의하는 형태로 실습
public class Test092
{
	public static void main(String[] args)
	{
		...
		int[] copys2 =copyArray(nums);		//깊은 의미의 배열 복사 수행 (사용자 정의 메소드 호출)

		int[] copys3 =(int[])nums.clone();	//깊은 의미의 배열 복사 수행 (자바에서 제공 -> clone() 메소드)
	...
	{
		//매개변수로 넘겨받은 배열(os)
		//즉, 원본 배열 만큼의 배열방을 확보한	복사할 배열방 생성
